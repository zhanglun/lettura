...
describe('request helpers', () => {
  ...
  describe('post', () => {
    it('should make a POST request with data', async () => {
      ...
      expect(mockAxiosInstance.post).toHaveBeenCalledWith('/create', data, undefined);
      expect(result).toEqual(mockResponse);
    });
    ...
    it('should pass config parameters to POST request', async () => {
      ...
      expect(mockAxiosInstance.post).toHaveBeenCalledWith('/create', data, config);
    });
  });
  ...
  describe('put', () => {
    it('should make a PUT request with data', async () => {
      ...
      expect(mockAxiosInstance.put).toHaveBeenCalledWith('/update/123', data, undefined);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe('delete', () => {
    ...
    it('should pass config parameters to DELETE request', async () => {
      ...
      expect(mockAxiosInstance.delete).toHaveBeenCalledWith('/delete/123', config);
    });
  });
});
