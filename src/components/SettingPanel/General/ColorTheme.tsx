      ...
      <div className="mt-6">
        ...
        >
          {[...new Array(17).keys()].map((idx) => {
            return <div className="grid gap-2 grid-flow-row items-center mb-2" key={idx}>

              <Radio value={idx + 1} className="flex flex-row items-center justify-center">
              <div className="">
                <div
                  className="flex border border-stroke p-4 pr-7 rounded"
                  style={{
                    backgroundColor: ThemeMap[`ColorPalette${idx+1}`].Section1ElementsBackground
                  }}>
                  <div
                    className="w-8 h-8 -mr-3 border-2 border-[#2b2c34]  rounded-full"
                    style={{
                      backgroundColor: ThemeMap[`ColorPalette${idx+1}`].Section1IllustrationHighlight
                    }}></div>
                  <div
                    className="w-8 h-8 -mr-3 border-2 border-[#2b2c34] rounded-full"
                    style={{
                      backgroundColor: ThemeMap[`ColorPalette${idx+1}`].Section1IllustrationSecondary
                    }}></div>
                  <div
                    className="w-8 h-8 -mr-3 border-2 border-[#2b2c34]  rounded-full"
                    style={{
                      backgroundColor: ThemeMap[`ColorPalette${idx+1}`].Section1IllustrationTertiary
                    }}></div>
                  <div
                    className="w-8 h-8 -mr-3 border-2 border-[#2b2c34]  rounded-full"
                    style={{
                      backgroundColor: ThemeMap[`ColorPalette${idx+1}`].Section1IllustrationStroke
                    }}></div>
                  <div
                    className="w-8 h-8 -mr-3 border-2 border-[#2b2c34]  rounded-full"
                    style={{
                      backgroundColor: ThemeMap[`ColorPalette${idx+1}`].Section1IllustrationMain
                    }}></div>
                </div>
              </div>
              </Radio>
