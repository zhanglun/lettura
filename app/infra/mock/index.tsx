export const channelList = [
  {
    ...
    name: 'Aerified',
    feedUrl:
      'https://businessweek.com/ullamcorper/augue/a/suscipit/nulla.aspx?proin=ultrices&eu=posuere&mi=cubilia&nulla=curae&ac=donec&enim=pharetra&in=magna&tempor=vestibulum&turpis=aliquet&nec=ultrices&euismod=erat&scelerisque=tortor&quam=sollicitudin&turpis=mi&adipiscing=sit&lorem=amet&vitae=lobortis&mattis=sapien&nibh=sapien&ligula=non&nec=mi&sem=integer&duis=ac&aliquam=neque&convallis=duis&nunc=bibendum&proin=morbi&at=non&turpis=quam&a=nec&pede=dui&posuere=luctus',
    icon:
    ...
    createTime: '3/30/2020',
    category: 'Lecidea congesta Fink',
    tag: 'Lecideaceae',
    groupName: 'Lecidea Lichen',
  },
  {
    id: 2,
    name: 'Toughjoyfax',
    feedUrl:
      'https://rediff.com/est/quam/pharetra/magna/ac/consequat/metus.json?faucibus=cursus&orci=urna&luctus=ut&et=tellus&ultrices=nulla&posuere=ut&cubilia=erat&curae=id&donec=mauris&pharetra=vulputate&magna=elementum&vestibulum=nullam&aliquet=varius&ultrices=nulla&erat=facilisi&tortor=cras&sollicitudin=non&mi=velit&sit=nec&amet=nisi&lobortis=vulputate&sapien=nonummy&sapien=maecenas&non=tincidunt&mi=lacus&integer=at&ac=velit&neque=vivamus&duis=vel&bibendum=nulla&morbi=eget&non=eros&quam=elementum&nec=pellentesque',
    icon:
    ...
    createTime: '8/17/2020',
    category: 'Myosurus apetalus C. Gay var. montanus (G.R. Campb.) Whitemore',
    tag: 'Ranunculaceae',
    groupName: 'Bristly Mousetail',
  },
  {
    id: 3,
    name: 'Tres-Zap',
    feedUrl:
      'http://gmpg.org/mauris/morbi/non.js?diam=rutrum&id=at&ornare=lorem&imperdiet=integer&sapien=tincidunt&urna=ante&pretium=vel&nisl=ipsum&ut=praesent&volutpat=blandit&sapien=lacinia&arcu=erat&sed=vestibulum&augue=sed&aliquam=magna&erat=at&volutpat=nunc&in=commodo&congue=placerat&etiam=praesent&justo=blandit&etiam=nam&pretium=nulla&iaculis=integer&justo=pede&in=justo&hac=lacinia&habitasse=eget&platea=tincidunt&dictumst=eget&etiam=tempus&faucibus=vel&cursus=pede&urna=morbi&ut=porttitor&tellus=lorem',
    icon:
  ...
  },
  {
    ...
    createTime: '2/7/2020',
    category: 'Stellaria obtusa Engelm.',
    tag: 'Caryophyllaceae',
    groupName: 'Rocky Mountain Chickweed',
  },
  {
    id: 5,
    name: 'Transcof',
    feedUrl:
      'https://over-blog.com/erat/tortor/sollicitudin/mi.json?convallis=venenatis&nulla=non&neque=sodales&libero=sed&convallis=tincidunt&eget=eu&eleifend=felis&luctus=fusce&ultricies=posuere&eu=felis&nibh=sed&quisque=lacus&id=morbi&justo=sem&sit=mauris&amet=laoreet&sapien=ut&dignissim=rhoncus&vestibulum=aliquet',
    icon:
  ...
  },
  {
    ...
    createTime: '3/31/2020',
    category:
      'Petalonyx thurberi A. Gray ssp. gilmanii (Munz) Davis & H.J. Thomp.',
    tag: 'Loasaceae',
    groupName: 'Death Valley Sandpaper Plant',
  },
  {
    id: 8,
    name: 'Y-Solowarm',
    feedUrl:
      'http://blogger.com/velit.jpg?aliquet=morbi&at=porttitor&feugiat=lorem&non=id&pretium=ligula&quis=suspendisse&lectus=ornare&suspendisse=consequat&potenti=lectus&in=in&eleifend=est&quam=risus&a=auctor&odio=sed&in=tristique&hac=in&habitasse=tempus&platea=sit&dictumst=amet&maecenas=sem&ut=fusce&massa=consequat&quis=nulla&augue=nisl&luctus=nunc&tincidunt=nisl&nulla=duis&mollis=bibendum&molestie=felis&lorem=sed&quisque=interdum&ut=venenatis&erat=turpis&curabitur=enim&gravida=blandit&nisi=mi&at=in&nibh=porttitor&in=pede&hac=justo&habitasse=eu&platea=massa&dictumst=donec&aliquam=dapibus&augue=duis&quam=at&sollicitudin=velit&vitae=eu&consectetuer=est&eget=congue&rutrum=elementum&at=in&lorem=hac&integer=habitasse',
    icon:
    ...
    createTime: '9/1/2020',
    category: 'Astragalus hornii A. Gray',
    tag: 'Fabaceae',
    groupName: "Horn's Milkvetch",
  },
  {
    id: 9,
    name: 'Otcom',
    feedUrl:
      'https://sogou.com/vulputate/ut.js?eget=dolor&congue=quis&eget=odio&semper=consequat&rutrum=varius&nulla=integer&nunc=ac',
    icon:
  ...
  },
  {
    ...
    createTime: '8/9/2020',
    category: 'Calymperes Sw.',
    tag: 'Calymperaceae',
    groupName: 'Calymperes Moss',
  },
  {
    id: 11,
    name: 'Overhold',
    feedUrl:
      'https://eventbrite.com/sed.png?sed=tempor&ante=turpis&vivamus=nec&tortor=euismod&duis=scelerisque&mattis=quam&egestas=turpis&metus=adipiscing&aenean=lorem&fermentum=vitae&donec=mattis&ut=nibh&mauris=ligula&eget=nec&massa=sem&tempor=duis&convallis=aliquam&nulla=convallis&neque=nunc&libero=proin&convallis=at&eget=turpis&eleifend=a&luctus=pede&ultricies=posuere&eu=nonummy&nibh=integer&quisque=non&id=velit&justo=donec&sit=diam&amet=neque&sapien=vestibulum&dignissim=eget&vestibulum=vulputate&vestibulum=ut&ante=ultrices&ipsum=vel',
    icon:
  ...
  },
  {
    ...
    createTime: '9/26/2020',
    category: 'Artemisia aleutica Hultén',
    tag: 'Asteraceae',
    groupName: 'Aleutian Wormwood',
  },
  {
    id: 13,
    name: 'Y-find',
    feedUrl:
      'http://mozilla.org/convallis/duis/consequat/dui/nec/nisi.aspx?ac=dapibus&nibh=dolor&fusce=vel&lacus=est&purus=donec&aliquet=odio&at=justo&feugiat=sollicitudin&non=ut&pretium=suscipit&quis=a&lectus=feugiat&suspendisse=et&potenti=eros&in=vestibulum&eleifend=ac&quam=est&a=lacinia&odio=nisi&in=venenatis&hac=tristique&habitasse=fusce&platea=congue&dictumst=diam&maecenas=id&ut=ornare&massa=imperdiet&quis=sapien&augue=urna&luctus=pretium&tincidunt=nisl&nulla=ut&mollis=volutpat&molestie=sapien&lorem=arcu',
    icon:
    ...
    createTime: '2/20/2020',
    category: 'Mesembryanthemum L.',
    tag: 'Aizoaceae',
    groupName: 'Iceplant',
  },
  {
    ...
    createTime: '12/31/2019',
    category: 'Bromus marginatus Nees ex Steud.',
    tag: 'Poaceae',
    groupName: 'Mountain Brome',
  },
  {
    id: 15,
    name: 'Biodex',
    feedUrl:
      'https://yellowbook.com/velit/nec/nisi.json?lacus=in&curabitur=felis&at=donec&ipsum=semper&ac=sapien&tellus=a&semper=libero&interdum=nam&mauris=dui&ullamcorper=proin&purus=leo&sit=odio&amet=porttitor&nulla=id&quisque=consequat&arcu=in&libero=consequat&rutrum=ut&ac=nulla',
    icon:
  ...
  },
  {
    ...
    createTime: '9/15/2020',
    category: 'Sambucus palmensis Link',
    tag: 'Caprifoliaceae',
    groupName: 'Sauco',
  },
  {
    ...
    name: 'Toughjoyfax',
    feedUrl:
      'http://mysql.com/pretium/iaculis.aspx?risus=proin&auctor=risus&sed=praesent&tristique=lectus&in=vestibulum&tempus=quam&sit=sapien&amet=varius&sem=ut&fusce=blandit&consequat=non&nulla=interdum&nisl=in&nunc=ante&nisl=vestibulum&duis=ante&bibendum=ipsum&felis=primis&sed=in&interdum=faucibus&venenatis=orci&turpis=luctus&enim=et&blandit=ultrices&mi=posuere&in=cubilia&porttitor=curae&pede=duis&justo=faucibus&eu=accumsan&massa=odio&donec=curabitur&dapibus=convallis&duis=duis&at=consequat&velit=dui&eu=nec&est=nisi&congue=volutpat&elementum=eleifend&in=donec&hac=ut&habitasse=dolor&platea=morbi&dictumst=vel&morbi=lectus&vestibulum=in',
    icon:
    ...
    createTime: '8/28/2020',
    category: 'Dodecahema leptoceras (A. Gray ex Benth.) Reveal & Hardham',
    tag: 'Polygonaceae',
