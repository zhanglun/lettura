...
module.exports = {
  ...
  theme: {
    ...
    colors: ({ colors }) => ({
      ...
      button: "hsl(var(--background) / <alpha-value>)",
      ...
      "feed-active-bg": "hsl(var(--feed-active-bg-color) / <alpha-value>)",
      "feed-active-headline": "hsl(var(--feed-active-headline-color) / <alpha-value>)",
